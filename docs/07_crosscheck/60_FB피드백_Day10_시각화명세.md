...
### 2-1. CloudVisualizationManager (신규 컴포넌트)
 ...
 | cloudUI UI 프리팹 | GameObject | Cloud_UI.prefab | 구름 UI UI 프리팹 (아래 명세) |
 ...
 | inputFieldUI UI 프리팹 | GameObject | ThoughtInput_UI.prefab | 생각 입력 팝업 UI 프리팹 |
