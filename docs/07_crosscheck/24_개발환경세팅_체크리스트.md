...
body { font-family: 'Noto Sans KR', 'Malgun Gothic', sans-serif; background: #0f1117; color: #e2e8f0; min-height: 100vh; }
nav { background: #1a1f2e; padding: 14px 28px; display: flex; align-items: center; gap: 12px; position: sticky; top: 0; z-index: 100; box-shadow: 0 2px 12px rgba(0,0,0,0.4); border-bottom: 1px solid #2d3748; }
nav a { color: #7c9ef8; text-decoration: none; font-size: 0.85rem; font-weight: 700; }
nav a:hover { color: #fff; }
nav span { color: #4a5568; }
nav .cur { color: #a0aec0; font-size: 0.85rem; }
.content { max-width: 900px; margin: 0 auto; padding: 52px 28px 100px; }
h1 { color: #90cdf4; font-size: 1.85rem; margin-bottom: 8px; font-weight: 900; letter-spacing: -0.5px; }
h2 { color: #7c9ef8; font-size: 1.2rem; margin: 38px 0 14px; padding-bottom: 10px; border-bottom: 2px solid #2d3748; font-weight: 800; }
h3 { color: #76e4f7; font-size: 1.02rem; margin: 26px 0 10px; font-weight: 700; }
h4 { color: #a0aec0; font-size: 0.95rem; margin: 18px 0 8px; font-weight: 700; }
p { margin-bottom: 13px; color: #cbd5e0; line-height: 1.85; }
ul, ol { margin: 8px 0 16px 22px; }
li { margin-bottom: 7px; color: #cbd5e0; line-height: 1.7; }
table { width: 100%; border-collapse: collapse; margin: 18px 0; font-size: 0.87rem; display: block; overflow-x: auto; }
th { background: #1e2a3a; color: #7c9ef8; padding: 10px 14px; text-align: left; border: 1px solid #2d3748; font-weight: 700; white-space: nowrap; }
td { padding: 9px 14px; border: 1px solid #2d3748; color: #cbd5e0; }
tr:nth-child(even) td { background: #141820; }
tr:hover td { background: #1a2235; }
code { background: #1e2a3a; color: #68d391; padding: 2px 7px; border-radius: 4px; font-size: 0.87em; }
pre { background: #1a1f2e; border: 1px solid #2d3748; border-radius: 8px; padding: 18px; overflow-x: auto; margin: 16px 0; }
pre code { background: none; color: #68d391; font-size: 0.84em; }
blockquote { border-left: 3px solid #4299e1; padding: 12px 20px; margin: 16px 0; color: #90a4ae; background: #141820; border-radius: 0 8px 8px 0; }
hr { border: none; border-top: 1px solid #2d3748; margin: 32px 0; }
strong { color: #f7fafc; font-weight: 700; }
em { color: #76e4f7; font-style: italic; }
a { color: #7c9ef8; }
...
| **Firebase Unity SDK** | `12.x` (2022.3 LTS 호환) | Firebase Console → 프로젝트 설정 → SDK 다운로드 
...
3. VARCO 3D 임포트 에셋은 임포트 후 위 방법으로 일괄 변환
`
