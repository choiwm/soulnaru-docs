---
source_html: 60_FB피드백_49번_업데이트.html
exported: 2026-05-01
---

# 60번 — FB-01 Day10 시각화 UI 명세 (49번 업데이트) · 소울나루
...
베니: "이제 마음에 떠오른 생각이 있으면, 구름에 올려보내 봐요. 생각이 없어도 괜찮아요."
ThoughtInput_UI 팝업 → 사용자 입력 또는 건너뛰기

4

구름 시각화 루프 (최대 5개)

SpawnThoughtCloud(text) → Cloud drift 시작 → 사용자 탭 → 흘려보내기 → 다음 생각 입력 가능
또는 2분 경과 시 자동으로 EndVisualization()
...
[37번 BreathingGuide UI](/benny/37_BreathingGuide_UI_디자인스펙.html) ·
